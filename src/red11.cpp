...
Renderer *Red11::createRenderer(Window *window, RendererType rendererType, AntialiasingMethod antialiasingMethod, bool bVSync)
{
    return new DirectX9Renderer(window, antialiasingMethod, bVSync);
}
